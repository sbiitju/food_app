...
class AuthPage extends StatelessWidget {
  ...
  AuthPage({Key? key, required this.function}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: LoginOtpButton(
                        ...
                        color: controller.isSubmitBtnActive.value
                            ...
                            : Colors.black26,
                        clickEvenListener: () {
                          if (phoneControllerET.text.length == 11) {
                            controller
                                .verifyOTP(
                              ...
                              baseController.isLogedIn.value = true;
                              function();
                            });
                          } else if (phoneControllerET.text.length == 10) {
                            controller
                                .verifyOTP(phoneControllerET.text,
                                    otpControllerET.text)
                                .then((value) {
                              saveToken(value.token);
                              controller.isSubmitBtnActive.value = false;
